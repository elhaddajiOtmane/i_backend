...
class PromotionalBanner extends \yii\db\ActiveRecord
{
    ...
    public function getImageUrl(){
        ...
        //     $image  ='default.png';
        // }
        // return Yii::$app->params['siteUrl'].Yii::$app->urlManagerFrontend->baseUrl.'/uploads/promotional-banner/original/'.$image;
        $modelFileUpload = new FileUpload();
        return $modelFileUpload->getFileUrl($modelFileUpload::TYPE_PROMOTIONAL_BANNER,$this->image);
