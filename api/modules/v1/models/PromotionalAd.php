...
class PromotionalAd extends \yii\db\ActiveRecord
{
    ...
    public function getImageUrl(){
        ...
        return $modelFileUpload->getFileUrl($modelFileUpload::TYPE_PROMOTIONAL_AD,$this->image);
    ...
    public function getVideoUrl(){
        ...
        $modelFileUpload = new FileUpload();
        return $modelFileUpload->getFileUrl($modelFileUpload::TYPE_PROMOTIONAL_AD,$this->video);
