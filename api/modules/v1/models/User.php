...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['sex', 'available_coin', 'is_email_verified', 'is_phone_verified', 'account_created_with', 'is_biometric_login', 'is_push_notification_allow', 'like_push_notification_status', 'comment_push_notification_status', 'is_chat_user_online', 'chat_last_time_online', 'smoke_id', 'marital_status', 'country_id', 'state_id', 'city_id', 'work_experience_month', 'work_experience_year', 'profile_category_type', 'profile_visibility','follower_status','following_status'], 'integer'],
            //[['email'], 'email'],
