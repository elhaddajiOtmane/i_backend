...
class DriverDocument extends \yii\db\ActiveRecord
{
    ...
    public function getDlImageUrl()
    {
        ...
        return $modelFileUpload->getFileUrl($modelFileUpload::TYPE_CAR_RIDE, $this->documents->driving_license);
    }

    public function getRcImageUrl()
    {
        $modelFileUpload = new FileUpload();
        return $modelFileUpload->getFileUrl($modelFileUpload::TYPE_CAR_RIDE, $this->documents->registration_certificate);
    }
    public function getViImageUrl()
    {
        $modelFileUpload = new FileUpload();
        return $modelFileUpload->getFileUrl($modelFileUpload::TYPE_CAR_RIDE, $this->documents->vehicle_insurance);
    }

    public function getVpImageUrl()
    {
        $modelFileUpload = new FileUpload();
        return $modelFileUpload->getFileUrl($modelFileUpload::TYPE_CAR_RIDE, $this->documents->vehicle_permit);
    }
