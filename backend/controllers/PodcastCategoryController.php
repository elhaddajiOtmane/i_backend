...
use backend\models\PodcastCategorySearch;
...
class PodcastCategoryController extends Controller
{
    ...
    {
        $searchModel = new PodcastCategorySearch();
    ...
    public function actionDelete($id)
    {
        ...
        $userModel->status =  PodcastCategory::STATUS_DELETED;
    ...
    {
        if (($model = PodcastCategory::findOne($id)) !== null) {
            return $model;
        }
